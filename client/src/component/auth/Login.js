  ...
  return (
    <div className=" bg-blue-200  ">
      <div className=" mx-auto flex items-center relative">
        <div className="hidden sm:block sm:w-3/6 lg:w-3/6 px-10">
        ...
        <div className=" w-full sm:w-3/6 lg:w-4/6 relative flex justify-center items-center bg-white">
          <div className="    flex justify-center items-center sm:max-w-sm  w-11/12">
                ...
                <form action="#" class="flex flex-col space-y-5">
                  ...
                  <div class="flex flex-col space-y-5">
                    ...
                    <div class="flex flex-col space-y-4">
                      <a
                        href="#"
                        class="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border bg-gray-800 rounded-md group hover:bg-red-600 focus:outline-none bg-opacity-90"
                      >
                        <span>
                          <svg
                            width="20"
